# Quality Catalog — platform variant (Seed)
...
>
> Variant scope: the full multi-surface platform — backend + web + iOS + Android, AI
> model integrations and the token economy. This variant IS the master, verbatim.
