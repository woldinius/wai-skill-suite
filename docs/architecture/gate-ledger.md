...
| 2026-08-14T16:45Z | 28 | NO-GO | ✗ required check(s) not green: ci=IN_PROGRESS; ✗ touches an excluded domain — the human merges these, always: EX-CONTRACT; ✓ quality catalog present; ✓ repo mode: solo | ok|
