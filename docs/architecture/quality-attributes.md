...
> **Status:** binding · **Owner:** Platform Architecture · **As of:** 2026-07-11 · **Version:** 3.0
>
...
>
> Single Source of Truth. The skills `wai-pr-review`, `wai-requirements-planning`
> and `wai-implementation` reference this file. Each dimension carries a
...
> do not reassign IDs that have already been issued.
