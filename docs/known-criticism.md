...
| K3 | fp/fn — "the measurement that matters" — had n ≈ 0 | **open, second dataset in** — this repo's rows are tagged (40 judged NO-GOs, 0 fp; 0 fn of 9 judged GO); a field repo reports 259 verdicts, **fp 14 of 148 judged NO-GOs = 9.5 %, fn 0 of 81 judged GO** over 2026-07-22 → 2026-09-05 ([field report](field-reports/2026-09-06-two-months-of-gate-259-verdicts.md), dated), after fp 8 of 52 = 15 % over its first three weeks and 12 judged NO-GOs with 0 fp / 0 fn over its first 30 runs; twelve of the fourteen false alarms had one root (#67, PR #71). Still one author's repos — Q7 |
