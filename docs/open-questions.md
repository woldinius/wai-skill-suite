...
API; the report itself is not published) confirmed what the README's *Limits* paragraph says
in prose — and turned it into a list of
...
|---|---|---|---|
| Q1 | Does the gate ever say GO in this repo — or is "fail-closed" where it has always been? | **64 gate verdicts on record, 10 GO rows** (PR #17, 2026-08-06; PR #1, 2026-08-10; PR #4, 2026-08-11; PR #31, 2026-08-16; PR #45 twice, PR #47 and PR #49, 2026-08-19; PR #62, 2026-09-13; PR #76, 2026-09-14), **4 untagged**. A field repo reports 30 runs with GO 5 · NO-GO 22 · UNKNOWN 0 ([field report](field-reports/2026-08-06-thirty-runs-zero-false-negatives.md), dated), and 85 verdicts over its full three-week window ([2026-08-12 report](field-reports/2026-08-12-three-weeks-of-ledger.md), dated) | Answered for existence on 2026-08-06 — here and in a second repo; stays open as a rate until the ledger has enough GO rows to review weekly |
...
| Q3 | How often is the gate wrong? | This repo: **46 judged NO-GOs, 0 fp**; **0 fn of 10 judged GO rows**; 57 of 61 judgeable rows tagged (3 MOOT rows outside every rate), with one `need inspection` outside every rate. The next column's threshold is **met** (2026-08-18) — and 0 % over 46 judged NO-GOs is this repo's rate, not the suite's: a field repo measures **fp = 14 of 148 judged NO-GOs = 9.5 %, fn = 0 of 81 judged GO rows** over 2026-07-22 → 2026-09-05 and 259 verdicts (field repo fr-06287b7fb053, 2026-09-06, [field report](field-reports/2026-09-06-two-months-of-gate-259-verdicts.md), dated — twelve of the fourteen false alarms had one root (#67, PR #71); eleven further blocks were tagged *correct but unwanted*), after **fp = 8 of 52 = 15 %** over its first three weeks ([2026-08-12 report](field-reports/2026-08-12-three-weeks-of-ledger.md), dated) and 12 judged NO-GOs with 0 fp and 0 fn over its first 30 runs ([field report](field-reports/2026-08-06-thirty-runs-zero-false-negatives.md), dated — its numbers age with it) | ≥ 20 human-tagged rows here — **met**; read with `gate-stats.sh`. What stays open is the same extract from a repo this author does not own (Q7): one author's 0 % and a field repo's 9.5 % are not the same measurement. One `fn` outweighs ten `fp` |
...
| Q7 | Does the suite work outside its author's repos? | One author; eight field runs; the dataset of 2026-09-06 comes from a repo of a different product shape than the multi-surface platform — a game ([field report](field-reports/2026-09-06-two-months-of-gate-259-verdicts.md), dated) — but it is still the author's own, so the question stays open | ≥ 3 foreign repos with a pasted `gate-stats.sh` extract — see the field-report template |
...
| Q9 | Is the per-skill exposure table honest — which skills carry how much use? | The author's self-report (README §Skills): five daily, two periodic, two less-often, two once-per-repo, `wai-retro` not yet rated — plus the personal skill, daily by two developers; one field repo reports per-skill invocation counts — `wai-pr-review` 28 · `wai-testing` 25 · `wai-implementation` 15 · `wai-requirements-planning` 11 · `wai-retro` 3 · `wai-team` 2 · `wai-learning-gap` 1 · `wai-architecture-audit` 1 · `wai` 1 of 87 hook-counted invocations ([field report](field-reports/2026-09-06-two-months-of-gate-259-verdicts.md), dated; a floor — its denominator undercounted until 2026-09-03) | Field reports that name the skills they ran (the template asks); ≥ 3 foreign repos reporting per-skill usage |
