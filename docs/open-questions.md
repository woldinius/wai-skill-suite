...
|---|---|---|---|
| Q1 | Does the gate ever say GO in this repo — or is "fail-closed" where it has always been? | **14 gate verdicts on record, 3 GO rows** (PR #17, 2026-08-06; PR #1 and PR #4, 2026-08-11), **7 untagged**. A field repo reports 30 runs with GO 5 · NO-GO 22 · UNKNOWN 0 ([field report](field-reports/2026-08-06-thirty-runs-zero-false-negatives.md), dated) | Answered for existence on 2026-08-06 — here and in a second repo; stays open as a rate until the ledger has enough GO rows to review weekly |
