...
| Q3 | How often is the gate wrong? | This repo: 5 judged NO-GOs, 0 fp; the GO row tagged `ok`; one UNKNOWN row held as "need inspection"; fn = 0 — n still small. A field repo reports 12 judged NO-GOs with 0 fp and 0 fn over 30 runs ([field report](field-reports/2026-08-06-thirty-runs-zero-false-negatives.md), dated — its numbers age with it); over its full window the same repo measures fp = 8 of 52 judged NO-GOs = 15 % (field repo fr-06287b7fb053, 2026-08-12, [field report](field-reports/2026-08-12-three-weeks-of-ledger.md), dated) | ≥ 20 human-tagged rows here; read with `gate-stats.sh`. One `fn` outweighs ten `fp` |
