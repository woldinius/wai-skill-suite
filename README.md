...
could never say GO at all. That is why [`tests/`](tests/) exists — 435 cases, **founded** on bugs
...
tests/                                           # 435 cases for the deciding scripts — founded on bugs that shipped
