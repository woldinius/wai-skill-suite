...
could never say GO at all. That is why [`tests/`](tests/) exists — 433 cases, **founded** on bugs
...
tests/                                           # 433 cases for the deciding scripts — founded on bugs that shipped
