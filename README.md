...
could never say GO at all. That is why [`tests/`](tests/) exists — 415 cases, **founded** on bugs
...
tests/                                           # 415 cases for the deciding scripts — founded on bugs that shipped
