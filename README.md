...
could never say GO at all. That is why [`tests/`](tests/) exists — 440 cases, **founded** on bugs
...
tests/                                           # 440 cases for the deciding scripts — founded on bugs that shipped
