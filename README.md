...
could never say GO at all. That is why [`tests/`](tests/) exists — 443 cases, **founded** on bugs
...
tests/                                           # 443 cases for the deciding scripts — founded on bugs that shipped
