...
could never say GO at all. That is why [`tests/`](tests/) exists — 444 cases, **founded** on bugs
...
tests/                                           # 444 cases for the deciding scripts — founded on bugs that shipped
