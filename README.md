...
could never say GO at all. That is why [`tests/`](tests/) exists — 401 cases, **founded** on bugs
...
tests/                                           # 401 cases for the deciding scripts — founded on bugs that shipped
