...
could never say GO at all. That is why [`tests/`](tests/) exists — 422 cases, **founded** on bugs
...
tests/                                           # 422 cases for the deciding scripts — founded on bugs that shipped
