...
could never say GO at all. That is why [`tests/`](tests/) exists — 497 cases, **founded** on bugs
...
tests/                                           # 497 cases for the deciding scripts — founded on bugs that shipped
